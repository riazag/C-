...
int main()
{
    ...
    string itemCode[NUM_CATEGORIES][SIZE] = {{"A1", "A2", "A3"},
                                             {"B1", "B2", "B3"},
                                             {"C1", "C2", "C3"},
                                             {"D1", "D2", "D3"},
                                             {"E1", "E2", "E3"},
                                             {"F1", "F2", "F3"},
                                             {"G1", "G2", "G3"}};
    string description[NUM_CATEGORIES][SIZE] = {{"Compact", "Tower", "Mini"},
                                                {"8 GB", "16 GB", "32 GB"},
    ...
    double price[NUM_CATEGORIES][SIZE] = {{75.00, 150.00, 100.00},
                                          {79.99, 149.99, 299.99},
                                          {49.99, 89.99, 129.99},
                                          {59.99, 119.99, 199.99},
                                          {49.99, 89.99, 129.99},
