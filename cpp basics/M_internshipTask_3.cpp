...
int main()
{
    ...
    int additionalItemsCount = 0; // Count of additional items chosen
    int additionalChoice;         // Declare additionalChoice here
    ...
    if (additionalChoice == 1)
    {
        ...
        double amountSaved = discount * totalPrice;
        totalPrice -= amountSaved;

        cout << "Amount Saved: $" << amountSaved << endl;
        cout << "Updated Total Price (after discount): $" << totalPrice << endl;
    }
